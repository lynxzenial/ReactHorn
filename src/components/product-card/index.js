...
export default class ProductCard extends React.Component {
    render () {
        return (
            <div className="bg-gray-800 w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
            ...
            <div className="px-5 py-3">
                <h3 className="text-gray-300 uppercase">{this.props.name}</h3>
                <span className="text-gray-400 mt-2">{this.props.price}</span>
            </div>
            </div>
        )
    }
